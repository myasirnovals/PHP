...
<body>
    <main class="container">
        ...
        <section class="page-card">
            <h1 class="page-title">Tambah Kota Baru</h1>
            <form action="<?= site_url('city/simpan') ?>" method="post">
                <div class="form-grid">
                    ...
                    <input id="distrik" type="text" name="distrik" required>

                    <label for="populasi">Populasi</label>
                    <input id="populasi" type="number" name="populasi" required>
                </div>
