...
<body>
    <main class="container">
        ...
        <section class="page-card">
            <h1 class="page-title">Tambah Negara Baru</h1>
            <form action="<?= site_url('country/simpan') ?>" method="post">
                <div class="form-grid">
                    <label for="kode">Kode</label>
                    <input id="kode" type="text" name="kode" maxlength="3" required>

                    <label for="nama">Nama</label>
                    <input id="nama" type="text" name="nama" required>

                    <label for="benua">Benua</label>
                    <input id="benua" type="text" name="benua" required>

                    <label for="wilayah">Wilayah</label>
                    <input id="wilayah" type="text" name="wilayah" required>
                </div>
