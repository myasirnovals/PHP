...
<header>
    ...
    <div class="menu">
        ...
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('/Tugas_lingkaran') ?>">Tugas Lingkaran</a></li>
            <li class="menu-item hidden"><a href="<?= base_url('/test') ?>">Test</a></li>
            <li class="menu-item hidden"><a href="<?= base_url('/test/hello') ?>">Test Hello</a></li>
            <li class="menu-item hidden"><a href="<?= base_url('/test/profil') ?>">Test Profil</a></li>
            <li class="menu-item hidden"><a href="<?= base_url('/calc') ?>">Calculator</a></li>
            <li class="menu-item hidden"><a href="<?= base_url('/tugas4') ?>">Tugas 4</a></li>
            <li class="menu-item hidden"><a href="<?= base_url('/latihan5') ?>">Latihan 5</a></li>
        </ul>
    </div>

    <div class="heroe">

        <h1>Selamat Datang di Praktikum Teknologi Web (Pertemuan 4)</h1>

        <h2>Muhamad Yasir Noval - 2350081004</h2>
...
<section>
    <h1 style="text-align: center; font-size: 32px">Hello World</h1>
</section>
