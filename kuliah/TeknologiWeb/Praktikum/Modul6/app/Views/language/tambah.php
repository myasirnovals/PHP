...
<body>
    <main class="container">
        ...
        <section class="page-card">
            <h1 class="page-title">Tambah Bahasa Baru</h1>
            <form action="<?= site_url('language/simpan') ?>" method="post">
                <div class="form-grid">
                    ...
                    <input id="bahasa" type="text" name="bahasa" required>
                    ...
                    <input id="persentase" type="number" step="0.01" name="persentase" required>
                </div>
