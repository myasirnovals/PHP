...
<body>
    <main class="container">
        ...
        <section class="page-card">
            <h1 class="page-title">Hapus Data Negara</h1>
            <p>Apakah Anda yakin menghapus negara <b><?= $negara->Name ?></b> (<?= $negara->Code ?>)?</p>
            <form action="<?= site_url('country/proses_hapus/'.$negara->Code) ?>" method="post">
